...
export function ProjectsList({ onProjectSelect, onSettingsClick }: ProjectsList = {}) {
  ...
  const loadProjects = async () => {
    try {
      // Bolt Performance Optimization: Fetch projects, prompts, and tools in parallel.
      // Replaces O(N) sequential loop calling LocalStorage queries for each project with a single-pass aggregation.
      ...
      // Aggregate counts in a single pass over prompts and tools collections
